...
const lahanData = [
    {
        ...
        activities: [
            ...
            { date: '2025-06-10', activity: 'Pengendalian Hama', note: 'Pestisida organik' },
        ],
        yieldHistory: [
    ...
    },
    {
        ...
        health: 72,
        activities: [
            { date: '2025-06-28', activity: 'Deteksi Penyakit', note: 'Bercak daun terdeteksi' },
            { date: '2025-06-27', activity: 'Aplikasi Fungisida', note: 'Mankozeb 2g/L' },
        ],
        yieldHistory: [
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="flex items-center justify-between">
                <div>
                    <h2 className="text-gray-900">Manajemen Lahan Digital</h2>
                    <p className="text-gray-500 mt-1">
                        Pencatatan dan monitoring seluruh lahan pertanian
                    </p>
                </div>
                    ...
                    <div className="space-y-3">
                        {lahanData.map((lahan) => (
                            <button
                                ...
                                className={`w-full text-left p-4 rounded-lg border-2 transition-all ${selectedLahan.id === lahan.id
