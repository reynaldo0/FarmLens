    ...
    return (
        <div className="space-y-6">
            ...
            <div className="bg-amber-50 border border-amber-200 rounded-xl p-4 flex items-start gap-3">
                ...
                <div>
                    <p className="text-amber-900">Peringatan Cuaca</p>
                    <p className="text-sm text-amber-700 mt-1">
                        Potensi hujan lebat pada 2-3 hari ke depan. Tunda penyemprotan pestisida.
                    </p>
                </div>
            </div>
                ...
                <div className="space-y-3">
                    <div className="flex items-start gap-3 p-4 bg-red-50 border border-red-200 rounded-lg">
                        ...
                        <div className="flex-1">
                            <p className="text-red-900">Deteksi potensi penyakit pada Lahan C</p>
                            <p className="text-sm text-red-700 mt-1">Lakukan inspeksi visual dan analisis lebih lanjut</p>
                        </div>
